...
chrome.storage.local.get(
  ...
  function (result) {
    ...
    console.log(result);
    console.log("____________________KEYS________________", keys);

    while (i--) {
      if (result[keys[i]]) {
        localStorage.setItem(keys[i], result[keys[i]]);
      }
    }
   ...
   !function (e) {
      ...
      var l = this["webpackJsonpsharepass-react"] = this["webpackJsonpsharepass-react"] || [],
         p = l.push.bind(l);
      l.push = r, l = l.slice();
